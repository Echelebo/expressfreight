							...
							<div class="row"> 
								...
								<div class="col-md-6"> 
									<div class="form-group"> 
										...
										<input type="text" class="form-control" id="lati" name="lati" placeholder="Location Latitude" > 
									</div> 
								</div>
								<div class="col-md-6"> 
									<div class="form-group"> 
										<label for="lngi" class="control-label">Longitude</label> 
										<input type="text" class="form-control" id="lngi" name="lngi" placeholder="Location Longitude" > 
									</div> 
								</div>
							</div>
							<div class="row"> 
