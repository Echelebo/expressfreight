...
<!-- Mirrored from demo.zytheme.com/equita/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Feb 2025 14:55:03 GMT -->
<head>
    <meta charset="utf-8"/>
    ...
    <title>Contact US - Equita Logistics Cargo HTML5 Template</title>
  ...
  <body>
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      <!-- Start .header-1-->
      <header class="header header-1 header-light" id="navbar-spy">
        <nav class="navbar navbar-expand-lg navbar-light navbar-fixed" id="primary-menu">
          <div class="container"><a class="navbar-brand" href="index.html"><img class="logo logo-light" src="assets/images/logo/logo-light.png" alt="Equita Logo"/><img class="logo logo-dark" src="assets/images/logo/logo-dark.png" alt="Equita Logo"/></a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                            <ul class="navbar-nav ml-auto">
                              ...
                              <li class="nav-item active"><a href="contact.html"><span>contact</span></a></li>
                            </ul>
