                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="about-inner-wrap">
                            <div class="section-title mb-0">
                                ...
                                <h2 class="title">WELCOME TO WORLD WIDE BEST
                                        LOGISTICS COMPANY</h2>
                                <p class="content left-line">Competently implement efficient logistics without cross-unit growth strategies.</p>
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="list-inner-wrap mb-lg-0 mb-4">
                                            <li><img src="assets/img/icon/check.png" alt="img"> Air Freight
</li>
                                            <li><img src="assets/img/icon/check.png" alt="img">Road Freight
</li>
                                            <li><img src="assets/img/icon/check.png" alt="img">Sea Freight
</li>
                                            <li><img src="assets/img/icon/check.png" alt="img">Warehouse</li>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="cta-inner-wrap" style="background: url(assets/img/video/bg.png);">
                        ...
                        <a class="btn btn-white" href="contact-us.php">CONTACT US</a>
                    </div>
                </div>
            </div>
        </div>
